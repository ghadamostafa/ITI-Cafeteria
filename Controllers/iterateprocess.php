...
$result= mysqli_query($conn,"SELECT b.order_id, b.date ,b.status ,b.notes , b.order_room, a.name , b.order_id FROM orders b INNER JOIN users a ON a.user_id = b.user_id WHERE b.status='processing'
");
...
<div class="row mt-5">
            ...
            <h2>processing.....</h2>
					...
					<li>
						<div class="row comments mb-2">
							...
							<div class="col-md-9 col-sm-9 col-9 comment rounded mb-2">
                                ...
                                <br>
                                <h1>Order Room: <br></h1> <h3><?php echo  $row['order_room'];?></h3>
							</div>
						</div>
					</li>
				</ul>
			   ...
			   <?php $order_id=$row['order_id']; include '../Controllers/iterateprocessitem.php';?>
